...
#Updated for Y-motif with one added particle
...
def eval_sim_1_1_ba(folder,names_sim_repeat,t_skip,t_lim,t_step,base_angle_distr_target):
    ...
    arms_names_2=[["y_link_a_1","y_arm_a_2","y_arm_a_2","y_arm_a_1"],
                  ["y_link_b_1","y_arm_b_2","y_arm_b_2","y_arm_b_1"],
                  ["y_link_c_1","y_arm_c_2","y_arm_c_2","y_arm_c_1"]]
...
def eval_sim_1_1_hp(folder,names_sim_repeat,t_skip,t_lim,t_step,link_HP_angle_distr_target):
    ...
    #names link HP angle 
    #each entry contains name of tip, then base of first vector and then tip and base of second vector, then repeat for next arm
    arms_names_2=[["y_link_hp_a_1","y_arm_a_2","y_arm_a_2","y_arm_a_1"],
                  ["y_link_hp_b_1","y_arm_b_2","y_arm_b_2","y_arm_b_1"],
                  ["y_link_hp_c_1","y_arm_c_2","y_arm_c_2","y_arm_c_1"]]
    ...
    for j in range(len(names_sim_repeat)):
        #folder,name,arms_names_1,arms_names_2,arms_names_3,arms_names_4,t_skip,t_lim,t_step,return_dict
        input_params_e=[folder,names_sim_repeat[j],
                        arms_names_1,
                        arms_names_2,
                        arms_names_3,
                        t_skip,t_lim,t_step]
...
def eval_sim_1_1_bm(folder,names_sim_repeat,t_skip,t_lim,t_step,angle_ds_fused_link_distr_target):
    ...
    #check which arms are fused

    #arms_names_2_fused=["y_arm_a_2","y_link_fused_a_1","y_link_fused_b_1","y_arm_b_2"]
    #arms_names_2_fused=["y_arm_a_2","y_link_fused_a_1","y_link_fused_c_1","y_arm_c_2"]
    arms_names_2_fused=["y_arm_b_2","y_link_fused_b_1","y_link_fused_c_1","y_arm_c_2"]

    #arms_names_2_fused=["y_arm_a_2","y_link_fused_a_1","y_link_fused_a_1","y_arm_a_2"]
    #arms_names_2_fused=["y_arm_b_2","y_link_fused_b_1","y_link_fused_b_1","y_arm_b_2"]
    #arms_names_2_fused=["y_arm_c_2","y_link_fused_c_1","y_link_fused_c_1","y_arm_c_2"]
